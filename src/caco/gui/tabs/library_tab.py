...
class LibraryTab(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._list_view.edit_metadata_requested.connect(self.edit_metadata_requested)
        self._list_view.edit_notes_requested.connect(self.edit_notes_requested)
        self._list_view.edit_sourceport_requested.connect(self.edit_sourceport_requested)
        self._list_view.edit_companions_requested.connect(self.edit_companions_requested)
        ...
        self._grid_view.edit_metadata_requested.connect(self.edit_metadata_requested)
        self._grid_view.edit_notes_requested.connect(self.edit_notes_requested)
        self._grid_view.edit_sourceport_requested.connect(self.edit_sourceport_requested)
        self._grid_view.edit_companions_requested.connect(self.edit_companions_requested)
        ...
        self._detail.edit_metadata_requested.connect(self.edit_metadata_requested)
